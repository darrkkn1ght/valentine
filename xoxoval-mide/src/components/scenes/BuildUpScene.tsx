...
export const BuildUpScene = ({ recipientName, senderName, customMessage, onContinue }: BuildUpSceneProps) => {
  const messages = customMessage
    ? [...defaultMessages.slice(0, 3), customMessage, defaultMessages[3]]
    : defaultMessages;
